...
export default class Marketing extends React.Component<PiramisAppContext, { hasError: boolean }> {
  ...
  render() {
    ...
    return <AppContainer {...this.props} routes={this.routes} name="CentraleOperativa" />;
  }
}
