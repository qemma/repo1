...
export default class Tagliandi extends React.Component<PiramisAppContext, { hasError: boolean }> {
  ...
  render() {
    ...
    return <AppContainer {...this.props} routes={this.routes} name="Dealer" />;
  }
}
